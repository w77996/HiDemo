...
//
//    @Bean(name = "getJedisClientConfiguration3")
...
//    }
//
//    @Bean(name = "getJedisConnectionFactory3")
//    @ConfigurationProperties(prefix = "redis3")
//    public JedisConnectionFactory getJedisConnectionFactory2(@Qualifier("getJedisClientConfiguration3") JedisClientConfiguration jedisClientConfiguration) {
...
//    public RedisTemplate getObjectRedisTemplate2(@Qualifier("getJedisConnectionFactory3") JedisConnectionFactory jedisConnectionFactory) {
